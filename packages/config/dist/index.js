...
export class ConfigLoader {
    ...
    loadUiConfig() {
        const config = {
            theme: this.getEnv('UI_THEME', 'auto'),
            ...
            pwa: {
                ...
                cacheStrategy: this.getEnv('PWA_CACHE_STRATEGY', 'cache-first'),
    ...
    loadAiConfig() {
        const config = {
            ...
            provider: this.getEnv('AI_PROVIDER', 'openai'),
    ...
    loadOfflineConfig() {
        const config = {
            ...
            cacheStrategy: this.getEnv('OFFLINE_CACHE_STRATEGY', 'conservative'),
            maxCacheAge: this.getEnvNumber('OFFLINE_MAX_CACHE_AGE', 86400000),
            syncInterval: this.getEnvNumber('OFFLINE_SYNC_INTERVAL', 300000),
            conflictResolution: this.getEnv('OFFLINE_CONFLICT_RESOLUTION', 'merge')
        };
