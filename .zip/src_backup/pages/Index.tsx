...
import { NeuCard, NeuCardContent } from "@components/theme/ui-neu/neu-card";
...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground overflow-x-hidden snap-y snap-mandatory">
