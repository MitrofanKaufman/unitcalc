...
Все значимые изменения в проекте Unit Calculator будут документироваться в этом файле.
...
- **Внешние API**: Курсы валют, погода и др.
...
- **Кеширование**: API responses и статические ресурсы
