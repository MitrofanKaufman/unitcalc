...
**Marketplace Tools** - это набор инструментов для работы с маркетплейсами, включающий:

- 🛒 **Анализ товаров** - мониторинг цен и конкурентов
- 📊 **Расчеты** - автоматизированные расчеты рентабельности
- 🤖 **Автоматизация** - инструменты для автоматизации рутинных задач
- 📈 **Аналитика** - детальная аналитика продаж и показателей

### Основные возможности

- **Поддержка основных маркетплейсов**: Wildberries, Ozon, Яндекс.Маркет
- **Кросс-платформенность**: веб, мобильные приложения, десктоп
- **Гибкая система интеграций**: API, вебхуки, CSV/Excel импорт/экспорт
- **Безопасность**: OAuth 2.0, JWT, шифрование данных
...
Подробнее о структуре проекта в [FILE_STRUCTURE.md](./FILE_STRUCTURE.md)
...
### Вариант 1: Полный стек (рекомендуется с Docker)
...
### Вариант 2: Изолированный запуск

#### API Gateway (основной сервер)
```bash
cd services/api-gateway
npm run dev  # Запуск в режиме разработки

# Или с отладкой
npm run dev:debug  # Запуск с отладчиком на порту 9229
```
...
# Запуск Metro bundler (в отдельном терминале)
npm start
...
- **Админ-панель**: http://localhost:3000/admin (если включена)
